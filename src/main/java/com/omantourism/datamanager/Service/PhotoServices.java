...
public class PhotoServices {
    ...
    public ResponseEntity<String> uploadImage(@RequestParam("file") MultipartFile file, @RequestParam("id") String id) {
        try {
            ...
            return ResponseEntity.status(500).contentType(MediaType.IMAGE_PNG).body("Error uploading image.");
        }
    }
        ...
        try {
            ...
            if (existingFile.exists()) {
                ...
                if (existingFile.delete()) {
                    ...
                    return ResponseEntity.status(500).contentType(MediaType.ALL).body("Error updating image.");
                }
            } else {
